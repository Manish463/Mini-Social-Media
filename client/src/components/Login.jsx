  ...
  return (
    <div className='h-screen w-full  bg-(--bg-main) grid grid-cols-1 md:grid-cols-2'>
      ...
      <section className='flexbox'>
        <img className='h-full object-cover object-left hidden md:block' src="/images/login.jpg" alt="Register image" />
        <ToastContainer />
      </section>

      <section className='w-full h-screen flexbox text-(--text-primary) p-6'>
        <form onSubmit={handleSubmit(onSubmit)} className='w-98 h-96 md:h-110 vflexbox bg-(--card-bg) rounded-lg border-2 border-(--border-color) px-6 md:px-8 py-14'>
